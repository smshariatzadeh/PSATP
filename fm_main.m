...
% FM_MAIN create the main GUI for psatp
%
% HDL = FM_MAIN()
%
...
h3 = uimenu('Parent',h2, ...
            ...
            'Tag','SaveS');
h3 = uimenu('Parent',h2, ...
            'Callback','fm_simsave(''fm_lib.mdl'',Path.psatp)', ...
...
h2 = uimenu('Parent',h1, ...
            'Callback','fm_set sc', ...
            'Label','Short Circuit', ...
            'Tag','RunSC'); % add By s.M.Shariatzade        
...
h3 = uimenu('Parent',h2, ...
            ...
            'Tag','MailUCLM');
h3 = uimenu('Parent',h2, ...
            'Callback','web(''mailto:psatpforum@yahoo.com'');', ...
            'Label','psatpforum@yahoo.com', ...
            'Tag','MailYahoo');
h2 = uimenu('Parent',h1, ...
            'Callback','fm_enter(Path.psatp,Settings.version,Settings.date)', ...
            'Label','Splash Window', ...
            'Tag','Splashpsat');
...
h1 = uicontrol('Parent',h0, ...
               ...
               'Tag','PushClose'); %% edit by smshariatzadeh@yahoo.com
h1 = uicontrol('Parent',h0, ...
               'Units','normalized', ...
               'BackgroundColor',Theme.color02, ...
               'Callback','fm_set sc', ...
               ...
               'Tag','Pushbutton10'); % edited By s.M.Shariatzade        
h1 = uicontrol('Parent',h0, ...
               'Units','normalized', ...
               'BackgroundColor',Theme.color02, ...
               'Callback','fm_set opf', ...
...
if Settings.hostver < 8.04
  h1 = text(0.08*xdim,0.175*ydim,'psatp');
else
  h1 = text(0.08*xdim,ydim-0.175*ydim,'psatp');
end
set(h1, ...
    'Color',color1, ...
    'FontSize',12, ...
...
h1 = uicontrol('Parent',h0, ...
               ...
               'BackgroundColor',Theme.color02, ...
               'Callback','fm_set setpert', ...
               'Position',[0.58522 0.7101 0.0379 0.05], ...
...
%                'String','Data File', ...
%                'Style','text', ...
%                'Tag','StaticText9');   0.0379 0.9375 0.0379 0.05         
...
h1 = uicontrol('Parent',h0, ...
               ...
               'BackgroundColor',Theme.color02, ...
               'Callback','fm_set setdata', ...
               'Position',[0.58522 0.8338 0.04547 0.039037], ...
               'TooltipString','Open Data File', ...
               'Tag','Pushbutton7');% add by majid
...
h1 = uicontrol('Parent',h0, ...
               ...
               'Tag','Pushbutton4');%  modified By s.m. Shariatzadeh (-0.01)
h1 = uicontrol('Parent',h0, ...
...
h1 = uicontrol('Parent',h0, ...
               ...
               'BackgroundColor',Theme.color02, ...
               'Callback',fmlib, ...
               'Position',[0.0379*7+0.5*0.0379 0.9375 0.0379 0.05], ...
               'TooltipString','Open psatp Simulink Library', ...
               'Tag','Pushbutton8');
h1 = uicontrol('Parent',h0, ...
               ...
               'Tag','Pushbutton800');   %  add By s.m. Shariatzadeh        
h1 = uicontrol('Parent',h0, ...
               ...
               'Tag','Pushbutton1'); %  modified By s.m. Shariatzadeh (+0.01)

h1 = uicontrol('Parent',h0, ...
               'CData',fm_mat('main_sc'), ...
               'Units','normalized', ...
               'BackgroundColor',Theme.color02, ...
               'Callback','fm_set sc', ...
               'Position',[0.0379*8+0.0569+0.01+0.035 0.9375 0.0379 0.05], ...
               'TooltipString','Short Circuit Calculation', ...
               'Tag','Pushbutton100'); %  modified By s.m. Shariatzadeh (+0.01)
...
h1 = uicontrol('Parent',h0, ...
               ...
               'BackgroundColor',Theme.color02, ...
               'Callback','fm_cpf(''main'');', ...
               'Position',[0.0379*9+0.0569+0.01+0.04 0.9375 0.0379 0.05], ...
...
h1 = uicontrol('Parent',h0, ...
               ...
               'BackgroundColor',Theme.color02, ...
               'Callback','fm_set opf', ...
               'Position',[0.0379*10+0.0569+0.01+0.04 0.9375 0.0379 0.05], ...
...
h1 = uicontrol('Parent',h0, ...
               ...
               'BackgroundColor',Theme.color02, ...
               'Callback','fm_eigfig', ...
               'Position',[0.0379*11+0.0759+0.04 0.9375 0.0379 0.05], ...
               'TooltipString','Eigenvalue Analysis', ...
               'Tag','Pushbutton4');%  modified By s.m. Shariatzadeh (+0.035)
h1 = uicontrol('Parent',h0, ...
               'CData',fm_mat('main_time'), ...
               'Units','normalized', ...
               'BackgroundColor',Theme.color02, ...
               'Callback','fm_int', ...
               'Position',[0.0379*12+0.0759+0.04 0.9375 0.0379 0.05], ...
...
h1 = uicontrol('Parent',h0, ...
               ...
               'BackgroundColor',Theme.color02, ...
               'Callback','fm_dir(0)', ...
               'Position',[0.0379*13+0.0949+0.02 0.9375 0.0379 0.05], ...
...
h1 = uicontrol('Parent',h0, ...
               ...
               'BackgroundColor',Theme.color02, ...
               'Callback','fm_comp copen', ...
               'Position',[0.0379*14+0.0949+0.04 0.9375 0.0379 0.05], ...
...
h1 = uicontrol('Parent',h0, ...
               ...
               'BackgroundColor',Theme.color02, ...
               'Callback','fm_snap', ...
               'Position',[0.0379*15+0.0949+0.035 0.9375 0.0379 0.05], ...
...
h1 = uicontrol('Parent',h0, ...
               ...
               'BackgroundColor',Theme.color02, ...
               'Callback','fm_stat', ...
               'Position',[0.0379*16+0.1139+0.035 0.9375 0.0379 0.05], ...
...
h1 = uicontrol('Parent',h0, ...
               ...
               'BackgroundColor',Theme.color02, ...
               'Callback','fm_threed', ...
               'Position',[0.0379*17+0.1139+0.035 0.9375 0.0379 0.05], ...
...
h1 = uicontrol('Parent',h0, ...
               ...
               'BackgroundColor',Theme.color02, ...
               'Callback','fm_plotfig', ...
               'Position',[0.0379*18+0.1139+0.035 0.9375 0.0379 0.05], ...
...
h1 = uicontrol('Parent',h0, ...
               ...
               'BackgroundColor',Theme.color02, ...
               'Callback','fm_hist', ...
               'Position',[0.0379*19+0.1329+0.025 0.9375 0.0379 0.05], ...
               'TooltipString','History', ...
               'Tag','Pushbutton4');%  modified By s.m. Shariatzadeh (+0.025)
h1 = uicontrol('Parent',h0, ...
               'CData',fm_mat('main_info'), ...
               'Units','normalized', ...
               'BackgroundColor',Theme.color02, ...
               'Callback','fm_about', ...
               'Position',[0.0379*20+0.1625+0.015 0.9375 0.0379 0.05], ...
               'TooltipString','About psatp', ...
               'Tag','Pushbutton8');%  modified By s.m. Shariatzadeh (+0.015)
...
h1 = uicontrol('Parent',h0, ...
               ...
               'String',['psatp version ',Settings.version, ...
		    ', Copyright (C) 2002-2016 Federico Milano'], ...
